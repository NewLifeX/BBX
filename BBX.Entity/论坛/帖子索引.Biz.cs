...
namespace BBX.Entity
{
	...
	public partial class PostId : Entity<PostId>
	{
		#region 对象操作﻿
		...
		protected override void InitData()
		{
			...
			XTrace.WriteLine("删除太旧的数据，反正只要自增ID而已");
			Delete("");
		}
		...
		public static PostId FindByID(Int32 pid)
		{
			//if (Meta.Count >= 1000)
		...
		//public static EntityList<PostId> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		//{
