...
namespace BBX.Entity
{
    ...
    public partial class Failedlogin : EntityBase<Failedlogin>
    {
        #region 对象操作﻿
        static Failedlogin()
        {
            Meta.Factory.AdditionalFields.Add(__.ErrCount);
        }
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            if (!Dirtys[__.LastUpdate]) LastUpdate = DateTime.Now;
        }
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}失败登录数据……", typeof(Failedlogin).Name);

        //    var entity = new Failedlogin();
        //    entity.IP = "abc";
        //    entity.ErrCount = 0;
        //    entity.LastUpdate = DateTime.Now;
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}失败登录数据！", typeof(Failedlogin).Name);
        //}
        ...
        public static Failedlogin FindByIP(String ip)
        {
            //if (Meta.Count >= 1000)
            return Find(_.IP, ip);
            //else // 实体缓存
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Failedlogin FindByID(Int32 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.ID, id);
            else // 实体缓存
        ...
        //public static EntityList<Failedlogin> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
        ...
        #region 业务
        //public static Failedlogin GetErrLoginRecordByIP(string ip)
        //{
        //	//return DatabaseProvider.GetInstance().GetErrLoginRecordByIP(ip);
        //	//return FindAll(_.IP == ip, null, null, 0, 100);
        ...
        public static void AddErrLoginCount(string ip)
        {
            ...
            var entity = FindByIP(ip) ?? new Failedlogin();
            entity.IP = ip;
            entity.ErrCount++;
            entity.Save();
        }
        ...
        public static int DeleteErrLoginRecord(string ip)
        {
            ...
            var exp = _.IP == ip;
            exp &= _.LastUpdate < DateTime.Now.AddMinutes(-15);
