...
namespace BBX.Entity
{
    ...
    [DataObject]
    [Description("我的帖子")]
    [BindTable("MyPost", Description = "我的帖子", ConnName = "BBX", DbType = DatabaseType.SqlServer)]
    public partial class MyPost : IMyPost
    {
        #region 属性
        private Int32 _ID;
        /// <summary>编号</summary>
        ...
        [BindColumn(5, "Dateline", "日界线", null, "datetime", 3, 0, false)]
        ...
        #region 字段名
        /// <summary>取得我的帖子字段信息的快捷方式</summary>
        ...
        /// <summary>取得我的帖子字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编号</summary>
    ...
    /// <summary>我的帖子接口</summary>
    public partial interface IMyPost
    {
        #region 属性
        /// <summary>编号</summary>
        Int32 ID { get; set; }
