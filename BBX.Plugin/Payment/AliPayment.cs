...
namespace BBX.Plugin.Payment
{
    public class AliPayment : IPayment
    {
        ...
        private string _aliPay = "http://pay.newlifex.com/gateway/alipay.ashx?";
        ...
        private static string[] GetUrlParam(object obj)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                if (propertyInfo.GetValue(obj, null) != null && !(propertyInfo.Name == "Sign") && !(propertyInfo.Name == "Sign_Type"))
                {
