...
function bbcode2html(str) {
    ...
    for (var i = 0; i <= BBXCODE['num']; i++) {
        str = str.replace("[\tBBX_CODE_" + i + "\t]", BBXCODE['html'][i]);
    }
...
function parsecode(text) {
	BBXCODE['num']++;
	BBXCODE['html'][BBXCODE['num']] = '<div class="blockcode"><blockquote>' + htmlspecialchars(text) + '</blockquote></div>';
