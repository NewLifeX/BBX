<%@ Page Language="c#" Inherits="BBX.Web.Admin.addusergroupspecial" Codebehind="addusergroupspecial.aspx.cs" %>
...
<table width="100%">
	...
	<tr>
		...
		<td class="vtop">设置用户在相册中可以上传照片的字节总数.</td>
	</tr>
	</tbody>
	...
	<tr>
		...
		<td class="vtop">设置用户在个人空间中可以上传附件的字节总数.</td>
	</tr>
	</tbody>
    --%>
