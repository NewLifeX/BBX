<%@ Page Language="c#" Inherits="BBX.Web.Admin.editadminusergroup" EnableViewState="true" Codebehind="editadminusergroup.aspx.cs" %>
...
function setatatus(obj) {
    if (obj.id == "TabControl1_tabPage33_admingroupright_3") {
        if (document.getElementById("TabControl1_tabPage33_admingroupright_3").checked == true) {
            document.getElementById("TabControl1_tabPage33_admingroupright_2").checked = true;
        }
    }
    if (obj.id == "TabControl1_tabPage33_admingroupright_2") {
        if (document.getElementById("TabControl1_tabPage33_admingroupright_2").checked == false) {
            document.getElementById("TabControl1_tabPage33_admingroupright_3").checked = false;
         }
    }
}
</script>
...
<table width="100%">
    ...
    <tr>
        <td class="vtop rowform">
             <cc1:TextBox ID="groupTitle" runat="server" CanBeNull="必填" RequiredFieldType="暂无校验" MaxLength="50"></cc1:TextBox>
        </td>
        <td class="vtop"></td>
    </tr>
    ...
    <tr>
        <td class="vtop rowform">
             <a href="#" class="TextButton" onclick="javascript:window.location.href='global_allowparticipatescore.aspx?pagename=editadminusergroup&groupid=<%=Request.Params["groupid"]%>'">
编辑评分范围</a>
        </td>
        <td class="vtop"></td>
    </tr>
    ...
    <tr>
        <td class="vtop" colspan="2">
            <cc1:CheckBoxList ID="admingroupright" runat="server" Width="500px" Font-Size="12px">
                ...
                <asp:ListItem onClick="setatatus(this)" Value="allowdelpost">允许删除帖子</asp:ListItem>
                <asp:ListItem onClick="setatatus(this)" Value="allowmassprune">允许批量删除</asp:ListItem>
