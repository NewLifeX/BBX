<%@ Page Language="c#" Inherits="BBX.Web.Admin.editusergroupspecial" Codebehind="editusergroupspecial.aspx.cs" %>
...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			 <cc1:DropDownList ID="radminid" runat="server"></cc1:DropDownList>
		</td>
		<td class="vtop"></td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox ID="readaccess" runat="server" CanBeNull="可为空" RequiredFieldType="数据校验" ize="5" MaxLength="4"></cc1:TextBox>
	...
	<tr>
		<td class="vtop rowform">
			...
			<asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="SERVER" ControlToValidate="maxprice" ErrorMessage="请输入正整数或者零" ValidationExpression="^[0-9]*$">
			</asp:RegularExpressionValidator>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			...
			<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="SERVER" ControlToValidate="maxprice" ErrorMessage="请输入正整数或者零" ValidationExpression="^[0-9]*$">
			</asp:RegularExpressionValidator>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			  <a href="#" class="TextButton" onclick="javascript:window.location.href='global_allowparticipatescore.aspx?pagename=editusergroupspecial&groupid=<%=Request.Params["groupid"]%>'">编辑评分范围</a>
		</td>
		<td class="vtop"></td>
	</tr>
</table>
