...
<%@ Page Language="c#" Inherits="BBX.Web.Admin.editadvs" Codebehind="global_editadvs.aspx.cs" %>
...
<form id="Form1" method="post" runat="server">
	...
	<div id="adtype4" style="width: 100%; display: none">
		<uc1:PageInfo ID="PageInfo3" runat="server" Icon="information" Text="<ul><li>展现方式: 帖内广告显示于帖子标题的上方, 通常使用文字的形式. 当前页面有多个帖内广告时, 系统会从中抽取与每页帖数相等的条目进行随机显示. 您可以在 {forumproductname} 选项中的其他设置中修改每帖显示的广告数量.  </ul>  <ul><li>价值分析: 由于帖子是论坛最核心的组成部分, 位于帖子内容上方的帖内广告, 便可在用户浏览帖子内容时自然的被接受, 加上随机播放的特性, 适合于特定内容的有效推广, 也可用于论坛自身的宣传和公告之用. 建议设置多条帖内广告以实现广告内容的差异化, 从而吸引更多访问者的注意力. </ul>" />
	</div>
...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox ID="displayorder" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" Width="56px" MultiLine="true" MaxLength="7"></cc1:TextBox>
		</td>
		<td class="vtop"></td>
	</tr>
	...
	<tr>
		...
		<td class="vtop">设置广告广告结束的时间, 格式 yyyy-mm-dd</td>
	</tr>
	...
	<tbody id="htmlcode" style="display: none">
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox ID="wordcontent" runat="server" Width="200px" RequiredFieldType="暂无校验" CanBeNull="可为空"></cc1:TextBox>
		</td>
	...
	<tr>
		...
		<td class="vtop">请输入文字广告指向的 URL 链接地址, 以http://开头 建议选择640px * 1250px 的图片.</td>
	</tr>
	</tbody>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox ID="imgtitle" runat="server" Width="344px" RequiredFieldType="暂无校验" CanBeNull="可为空"></cc1:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox ID="imglink" runat="server" Width="250px" RequiredFieldType="暂无校验" CanBeNull="可为空" Text=""></cc1:TextBox>
		</td>
...
<div class="Navbutton">
<cc1:Button ID="UpdateADInfo" runat="server" Text=" 提 交 " ValidateForm="true"></cc1:Button>&nbsp;&nbsp;
...
//		    $('targetForum').style.display = ''; 
	...
	{
	   var oldSelectedValue = Form1.parameters.value;
	   ...
	   Form1.parameters.value = oldSelectedValue;
