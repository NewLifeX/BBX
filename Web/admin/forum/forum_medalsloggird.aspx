<%@ Page language="c#" Inherits="BBX.Web.Admin.medalsloggird" Codebehind="forum_medalsloggird.aspx.cs" %>
...
<cc1:datagrid id="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" PageSize="15" >
	<Columns>						
		...
		<asp:TemplateColumn HeaderText="操作者">
			<ItemTemplate>
				<a href="../../userinfo.aspx?userid=<%# Eval("adminid").ToString() %>" target="_blank">
