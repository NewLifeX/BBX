<%@ Page language="c#" Inherits="BBX.Web.Admin.addbbcode" Codebehind="forum_addbbcode.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="TextareaResize" Src="../UserControls/TextareaResize.ascx" %>
<%@ Register TagPrefix="cc1" Namespace="BBX.Control" Assembly="BBX.Control" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
<title><%=BBX.Common.Utils.ProductName%>代码添加</title>	
...
<fieldset>
<legend style="background:url(../images/icons/icon47.jpg) no-repeat 6px 50%;">添加<%=BBX.Common.Utils.ProductName%>代码</legend>
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			 <uc1:TextareaResize id="example" runat="server" HintTitle="提示" HintInfo="本代码作用的例子" controlname="example" cols="30" is_replace="true" maxlength="254" ></uc1:TextareaResize>
		</td>
		<td class="vtop"></td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			<uc1:TextareaResize id="explanation" runat="server" controlname="explanation" cols="30" is_replace="true" ></uc1:TextareaResize>
		</td>
		<td class="vtop">本代码功能的解释</td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:textbox id="nest" runat="server" Text="0" CanBeNull="必填" RequiredFieldType="数据校验" size="3"></cc1:textbox>
		</td>
...
<div class="Navbutton">
	<cc1:Button id="AddAdInfo" runat="server" Text=" 提 交 "></cc1:Button>
</div>
</fieldset>
</div>
</form>
